...
theme = {}
theme.icons = icons
--theme.wallpaper_cmd = { "feh --bg-max $XDG_CONFIG_HOME/awesome/lockscreen.png" }
theme.font = "DejaVu Sans 9" --"Terminus 10"
theme.tasklist_font = "DejaVu Sans 9"
...
theme.menu_border_color = "#FF7F00" 
